...
//extern int init_pospiece[33];
extern char canAttack[6][64][64]; // 6 types de pièces, 1 case source, 1 case destination
extern int table_KNIGHT[8][8]; // 8 cases sur la ligne, 8 cases sur la colonne -> 64 cases pour l echiquier?
extern int table_BISHOP[8][8];
extern int table_ROOK[8][8];
extern int table_KING[8][8];
extern int table_QUEEN[8][8];